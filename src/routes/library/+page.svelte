	...
	const isSynced = async () => {
		...
		if (libraryData.synced) {
			libraryStats = {
				...
				likedPlaylists: libraryData.likedPlaylists.reduce(
					(acc, curr) => acc + curr.tracks.length,
					0
				),
					...
					<Flex>
						...
						<Stack>
							...
							<Text size="sm" color="gray"
								>Your whole songs collection - {Object.values(libraryStats).reduce(
									(acc, curr) => acc + curr,
									0
								)} tracks</Text
							>
						...
						<div slot="control">
							<Flex>
								...
								<Stack>
									...
									<Text size="sm" color="gray"
										>The albums you liked - {libraryStats.likedAlbums} tracks</Text
									>
								</Stack>
							</Flex>
						</div>
						...
						<div slot="control">
							<Flex>
								...
								<Stack>
									...
									<Text size="sm" color="gray"
										>The playlists you liked - {libraryStats.likedPlaylists} tracks</Text
									>
								</Stack>
							</Flex>
						</div>
						...
						<div slot="control">
							<Flex>
								...
								<Stack>
									...
									<Text size="sm" color="gray"
										>The tracks you liked - {libraryStats.likedTracks} tracks</Text
									>
								</Stack>
							</Flex>
						</div>
						...
						<div slot="control">
							<Flex>
								...
								<Stack>
									...
									<Text size="sm" color="gray"
										>Your playlists - {libraryStats.playlists} tracks</Text
									>
								</Stack>
							</Flex>
						</div>
	...
	{:else}
		<Container size={500}>
			<Alert icon={InfoCircled} title="Not Ready Yet" color="red">
				<Group>
					Your library has not been synced yet ! <Button color="grape" on:click={sync}
						>Sync library<ThemeIcon variant="grape"><Reload size="16" /></ThemeIcon></Button
					>
				</Group>
			</Alert>
		</Container>
